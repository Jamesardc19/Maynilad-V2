        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/activities" className="hover:text-secondary transition-colors duration-300">
                  Activities
                </Link>
              </li>
              <li>
                <Link href="/formation" className="hover:text-secondary transition-colors duration-300">
                  Formation
                </Link>
              </li>
              <li>
                <Link href="/staff" className="hover:text-secondary transition-colors duration-300">
                  Staff
                </Link>
              </li>
              <li>
