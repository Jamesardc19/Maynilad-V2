    ...
    <footer className="bg-primary-dark text-white">
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-body text-xs font-semibold uppercase tracking-[0.15em] text-gold mb-6">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/60 hover:text-white font-body text-sm transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm font-body text-white/60">
              <p>
          ...
          <div>
            ...
            <div className="mt-8">
              <p className="text-xs font-body text-white/40 mb-3 uppercase tracking-wider">Office Hours</p>
              <p className="text-sm font-body text-white/60">Mon – Fri: 8:00 AM – 5:00 PM</p>
              <p className="text-sm font-body text-white/60">Sat: 8:00 AM – 12:00 PM</p>
            </div>
          </div>
        </div>
      </div>
